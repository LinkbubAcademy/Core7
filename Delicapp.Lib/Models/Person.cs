...
namespace Delicapp.Lib.Models
{
    ...
    {
        Dictionary<PersonActions, Dictionary<DelicappRoles, RolActionMap>> RolActionMaps { get; set; } = new();
        ...
        void RegisterCreate()
        {
            var systemPermissions = new RolActionMap(DelicappRolesHandler.System)
            {
                AllowAll = true
            };

            var writerPermissions = new RolActionMap(DelicappRolesHandler.Writer);
            var editorPermissions = new RolActionMap(DelicappRolesHandler.Editor);
            var readerPermissions = new RolActionMap(DelicappRolesHandler.Reader);

            var maps = new Dictionary<DelicappRoles, RolActionMap>();
            RolActionMaps.Add(PersonActions.Create, maps);

            maps.Add(DelicappRoles.System, systemPermissions);
            maps.Add(DelicappRoles.Writer, writerPermissions);
            maps.Add(DelicappRoles.Editor, editorPermissions);
            maps.Add(DelicappRoles.Reader, readerPermissions);
        }
